...
$(document).ready(function() {
	...
	$('#nation-calendar-view-1').DOPFrontendBookingCalendarPRO({'ID': "0","DataURL":"php/load.php"});
	$('#nation-calendar-view-2').DOPFrontendBookingCalendarPRO({'ID': "1","DataURL":"php/load.php"});
