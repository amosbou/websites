    ...
    echo '<div class="format-setting type-textblock wide-desc">';
      ...
      echo '<div class="description">';
        ...
        echo '<ul class="docs-ul">';
          ...
          echo '<li>' . __( 'Put the <code>option-tree</code> directory in the root of your theme. For example, the server path would be <code>/content/themes/theme-name/option-tree/</code>.', 'option-tree' ) . '</li>';
